...
A calendar program in C that empowers users to select any year and effortlessly visualizes the corresponding calendar.
...
```bash
 git clone https://github.com/JoelMoyal/calendar-C.git
```
